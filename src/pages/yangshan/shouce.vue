          ...
          <van-tab v-for="(item,index) in tabs" :title="item" :key="index">
            ...
            <div class="content" v-else-if="index==3">
              <div class="list-group">
                  <a  @click="download('yijian')" class=" list-group-item">
                    关于优化洋山保税港区通关环境的若干意见
                  </a>
                  <a  @click="download('yijian')" class=" list-group-item">
                      办理检验检疫手续须知
                  </a>
                  <a @click="download('xuzhi')" class=" list-group-item">
                      办理边防检查手续须知
                  </a>
                  <a  @click="download('kouan')" class=" list-group-item">
                      海事局洋山港口岸管理须知
                  </a>
                  <a @click="download('shenshui')" class=" list-group-item">
                      洋山深水港区码头服务指南
                  </a>
                  <a @click="download('fujian')"  class=" list-group-item">
                      附件
                  </a>
              </div>
            </div>
...
export default {
  ...
  methods:{
     download(val){//下载附件文档
                // location.href = "../../../doc_download/yijian.docx";
                let url ="../../../static/"+val+".docx";
                location.href=url;
            },
  }
};
